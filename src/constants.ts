...
export const DEFAULT_GAMES: Record<string, unknown>[] = [
  {
    id: 'g1',
    name: 'Blue Archive',
    color: '#4a9eff',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 't3', name: 'Weekly Boss', type: 'weekly', weeklyResetDay: 0 },
      { id: 't4', name: 'Serenitea Pot', type: 'weekly', weeklyResetDay: 0 },
      {
        id: 't5',
      ...
      { id: 't6', name: 'Spiral Abyss', type: 'monthly', monthlyResetDay: 15 },
    ],
  },
  {
    id: 'g3',
    ...
    items: [
      ...
      { id: 't9', name: 'Notorious Hunt', type: 'weekly', weeklyResetDay: 0 },
      { id: 't10', name: 'Hollow Zero', type: 'weekly', weeklyResetDay: 0 },
    ],
  },
  {
    id: 'g4',
